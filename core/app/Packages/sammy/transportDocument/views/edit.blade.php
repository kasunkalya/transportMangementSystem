...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Edit Document Layout</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Document Layout</strong>
      		</div>
          	<div class="panel-body">
          		...
          		{!!Form::token()!!}	
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('documentType'))
								{!! Form::select('documentType', $muthumalaDocument,$layout[0]->document_type_id,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'documentType']) !!}
								<label id="supervisor-error" class="error" for="ownerSection">{{$errors->first('ownerSection')}}</label>
							@else
								{!! Form::select('documentType', $muthumalaDocument, $layout[0]->document_type_id,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'documentType']) !!}
							@endif
						</div>
	                </div>	
					...
					<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('document_name')) error @endif" name="document_name" id="document_name" placeholder="Document Name" required value="{{$layout[0]->document_name}}">
					 ...
					 <label class="col-sm-2 control-label required">Document Layout</label> 
		            		<div  class="col-sm-12">
		            		<textarea class="ckeditor" id name="editor1">{{$layout[0]->document_layout}}</textarea>
