...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">
		<a href="{{{url('transportLorryFule/addInvoice')}}}">Add Fuel Invoice</a>
  	</li>
		...
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<div class="row">
						<div class="col-xs-6"><strong>Add New Invoice</strong></div>
                                ...
                                <div class="panel panel-bordered panel-primary" style="margin:5px;">
                                        ...
                                        <div class="panel-body" id="myRadioGroup">
                                              <label class="radio-inline">
                                                  <input type="radio" name="optradio" id="optradio" value="1" checked>Date
                                              </label>
                                              <label class="radio-inline">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                                @if($errors->has('customer'))
                                                                        {!! Form::select('customer',$customer, Input::old('lorry'),['placeholder' => 'Select supplier','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'customer']) !!}
                                                                        <label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
                                                                @else
                                                                        {!! Form::select('customer',$customer, Input::old('lorry'),['placeholder' => 'Select supplier','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'customer']) !!}
                                                                @endif
                                    ...
                                    <form role="form" class="form-horizontal form-validation" method="post">
                                        <table class="table table-bordered bordered table-striped table-condensed datatable">
                                            <thead>
                                                    <tr>
                                                            ...
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Fuel Date</th>
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Location</th>
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Chargers</th>	
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Vehicle Meter</th>	
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="pull-right">
                                                <button id="addInvoice" type="button" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Add Invoice</button>
                                            </div>
                                        </div>
                                    </form>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
           ...
           $("#content").hide();
            ...
            table = generateTable('.datatable', '{{url('transportLorryFule/json/fulesearchlist')}}/'+0+'/'+0+'/'+0+'/'+0+'/'+0,[],[]);
...
<script type="text/javascript">
        ...
        function loadTable(){
                  ...
                  if(optradio==2){
                    ...
                    table.destroy();
                    table = generateTable('.datatable', '{{url('transportLorryFule/json/fulesearchlist')}}/'+optradio+'/'+invoicedatefrom+'/'+invoicedateto+'/'+lorry+'/'+serviceValue,[],[]);
