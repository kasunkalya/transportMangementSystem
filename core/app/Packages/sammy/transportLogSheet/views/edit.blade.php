@extends('layouts.sammy_new.master') @section('title','Edit Log Sheet')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Edit Log Sheet</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Log Sheet</strong>
      		</div>
          		...
          		{!!Form::token()!!}
                        <div class="form-group" hidden="">
                                        <label class="col-sm-2 control-label required">Log Sheet Number</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @if($errors->has('sheetNumber')) error @endif" name="sheetNumber" id="sheetNumber" placeholder="Log Sheet Number" required value="{{$logsheet->logsheetNo}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">                                                												
                                                    <input type="text" class="form-control @if($errors->has('date')) error @endif" name="date" id="date" placeholder="Date" value="{{$logsheet->logsheetdate}}" >
                                                        @if($errors->has('date'))
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('lorry'))
								{!! Form::select('lorry', $lorry,$logsheet->lorryId,['placeholder' => 'Select Lorry','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('lorry', $lorry,$logsheet->lorryId,['placeholder' => 'Select Lorry','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
							@endif
			...
			<label class="col-sm-2 control-label required">Driver</label>
							...
							@if($errors->has('driver'))
								{!! Form::select('driver', $driver, $logsheet->driverid,['placeholder' => 'Select driver','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'driver']) !!}
								<label id="supervisor-error" class="error" for="driver">{{$errors->first('driver')}}</label>
							@else
								{!! Form::select('driver', $driver, $logsheet->driverid,['placeholder' => 'Select driver','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'driver']) !!}
							@endif
			...
			<label class="col-sm-2 control-label required">Helper</label>
							...
							@if($errors->has('helper'))
								{!! Form::select('helper', $driver,$logsheet->helperid,['placeholder' => 'Select helper','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'helper']) !!}
								<label id="supervisor-error" class="error" for="helper">{{$errors->first('helper')}}</label>
							@else
								{!! Form::select('helper', $driver,$logsheet->helperid,['placeholder' => 'Select helper','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'helper']) !!}
							@endif
                    ...
                    <label class="col-sm-2 control-label">Invoice Number</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @if($errors->has('invoice')) error @endif" name="invoice" id="invoice" placeholder="Invoice Number" value="{{$logsheet->invoiceNo}}">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Start Time</label>
                            <div class="col-sm-10">
                                 <input type="text" id="startTime" class="form-control @if($errors->has('startTime')) error @endif" name="startTime" placeholder="Start Time" value="{{$logsheet->startTime}}">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">End Time</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control @if($errors->has('endDate')) error @endif" name="endDate" id="endDate" placeholder="End Date" value="{{$logsheet->endTime}}">
                    ...
                    <label class="col-sm-2 control-label">Start Vehicle Meter</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @if($errors->has('startVehicleMeter')) error @endif" name="startVehicleMeter" id="startVehicleMeter" placeholder="Start Vehicle Meter" value="{{$logsheet->startMiter}}">
                    ...
                    <label class="col-sm-2 control-label">End Vehicle Meter</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control @if($errors->has('endVehicleMeter')) error @endif" name="endVehicleMeter" id="endVehicleMeter" placeholder="End Vehicle Meter" value="{{$logsheet->endMiter}}">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Trip Description</label>
                            <div class="col-sm-10">
                                <textarea class="form-control @if($errors->has('tripdescription')) error @endif" name="tripdescription" placeholder="Trip Description">{{$logsheet->tripDescription}}</textarea>
                     ...
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Other Description</label>
                            <div class="col-sm-10">
                                <textarea class="form-control @if($errors->has('otherdescription')) error @endif" name="otherdescription" placeholder="Other Description">{{$logsheet->description}}</textarea>
                    ...
                    <div class="form-group">
	            		...
	            		<div class="col-sm-10">
	            			...
	            			@else
	            				{!! Form::select('route[]',$route,$srole,['multiple','id'=>'route','style'=>'width:100%;height: 200px;','required']) !!}
	            			@endif
	            		</div>
	            </div>   
                        ...
                        <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                     <textarea class="form-control @if($errors->has('costdescription')) error @endif" name="costdescription" placeholder="Cost Description">{{$logsheet->costDescription}}</textarea>
                    ...
                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @if($errors->has('chargers')) error @endif" name="chargers" id="chargers" placeholder="Total Cost" value="{{$logsheet->costTotal}}">
                  ...
                  <div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('payable'))
								{!! Form::select('payable', array(null=>'Select Value','1' => 'Payable', '0' => 'None payable'),$logsheet->paymentStatus,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'payable']) !!}
								<label id="supervisor-error" class="error" for="ownerSection">{{$errors->first('ownerSection')}}</label>
							@else
								{!! Form::select('payable', array(null=>'Select Value','1' => 'Payable', '0' => 'None payable'),$logsheet->paymentStatus,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'payable']) !!}
							@endif
