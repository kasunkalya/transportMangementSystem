@extends('layouts.sammy_new.master') @section('title','Log Sheet List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
	...
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					<div class="col-xs-6"><strong>Log Sheet List</strong></div>
					<div class="col-xs-6 text-right"><a href="{{{url('transportLogSheet/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Log sheet Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
		                  	...
		                  	<th rowspan="2" class="text-center" style="font-weight:normal;">License Plate No</th>
		                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Log Sheet Number</th>
                                        <th rowspan="2" class="text-center" style="font-weight:normal;">Log Sheet Date</th>
                                        <th rowspan="2" class="text-center" style="font-weight:normal;">Payment Status</th>
		                  	<th colspan="4" class="text-center" width="4%" style="font-weight:normal;">Action</th>
		                </tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('transportLogSheet/json/list')}}',[],[]);
		...
		table.on('draw.dt',function(){
			...
			$('.type-delete').click(function(e){
				e.preventDefault();
				id = $(this).data('id');
				sweetAlertConfirm('Delete Log Sheet', 'Are you sure?',2, deleteFunc);
			});
		});
	});
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('transportLogSheet/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
