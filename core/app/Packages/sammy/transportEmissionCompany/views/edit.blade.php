@extends('layouts.sammy_new.master') @section('title','Edit Emission Company')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Edit Emission Company</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Emission Company</strong>
      		</div>
          	<div class="panel-body">
		        ...
		        <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('name')) error @endif" name="name" id="name" placeholder="Name" required value="{{$transportCompany->emission_company_name}}">
							@if($errors->has('name'))
