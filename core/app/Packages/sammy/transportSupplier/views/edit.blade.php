@extends('layouts.sammy_new.master') @section('title','Edit Transport Supplier')
@section('css')
<style type="text/css">
		...
		<div class="panel panel-bordered">
          	...
          	<div class="panel-body">
		         ...
		         <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('name')) error @endif" name="name" id="name"  placeholder="Name" required value="{{$customer->suppliers_name}}">
							@if($errors->has('name'))
	            		...
	            		<div class="col-sm-10">
                                    @if($errors->has('type'))
					{!! Form::select('type', array(null=>'Select Type','1' => 'Petrol Shed', '2' => 'Garage', '3' => 'Service Center', '4' => 'Other'), $customer->type,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'type']) !!}
					<label id="supervisor-error" class="error" for="ownerSection">{{$errors->first('ownerSection')}}</label>
                                    @else
					{!! Form::select('type', array(null=>'Select Type','1' => 'Petrol Shed', '2' => 'Garage', '3' => 'Service Center', '4' => 'Other'),$customer->type,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'type']) !!}
                                    @endif						
	            		</div>
	                </div>  
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('vat')) error @endif" name="vat" id="vat" placeholder="Vat Number"  value="{{$customer->vatNumber}}">
							@if($errors->has('vat'))
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('bankAccount')) error @endif" name="bankAccount" id="bankAccount" placeholder="Bank Account Number"  value="{{$customer->bankAccount}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('branch')) error @endif" name="branch" id="branch" placeholder="Branch"  value="{{$customer->branch}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('credit')) error @endif" name="credit" id="credit" placeholder="credit"  value="{{$customer->creditLimit}}">
