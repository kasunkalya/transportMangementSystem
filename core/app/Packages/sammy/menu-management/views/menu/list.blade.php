@extends('layouts.sammy_new.master') @section('title','Menu List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
		...
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
      			<div class="row"><div class="col-xs-6"><strong>Menu List</strong></div>
                            <div class="col-xs-6 text-right"><a href="{{{url('menu/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Add</button></a></div>
      			</div>
      		</div>
