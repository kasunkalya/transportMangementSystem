@extends('layouts.sammy_new.master') @section('title','Edit Maintain Record')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Edit Lorry Maintain Record</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Lorry Maintain Record</strong>
      		</div>
          	<div class="panel-body">
          		...
          		{!!Form::token()!!}
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('lorry'))
								{!! Form::select('lorry', $lorry, $maintain->lorry,['placeholder' => 'Select lorry','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('lorry', $lorry,$maintain->lorry,['placeholder' => 'Select lorry','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
							@endif
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
								...
								{!! Form::select('serviceStation', $service, $maintain->serviceStation,['placeholder' => 'Select service station','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'serviceStation']) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('serviceStation', $service,$maintain->serviceStation,['placeholder' => 'Select service station','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'serviceStation']) !!}
							@endif
