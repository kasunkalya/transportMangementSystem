@extends('layouts.sammy_new.master') @section('title','Edit Fuel Record')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Edit Fuel Record</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Fuel Record</strong>
      		</div>
          	<div class="panel-body">
          		...
          		{!!Form::token()!!}
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('lorry'))
								{!! Form::select('lorry', $lorry, $maintain->lorry,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('lorry', $lorry, $maintain->lorry,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
							@endif
			...
			<label class="col-sm-2 control-label required">Driver</label>
							...
							@if($errors->has('driver'))
								{!! Form::select('driver', $driver,$maintain->driver,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'driver']) !!}
								<label id="supervisor-error" class="error" for="driver">{{$errors->first('driver')}}</label>
							@else
								{!! Form::select('driver', $driver,$maintain->driver,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'driver']) !!}
							@endif
			...
			<div class="col-sm-10">     
								...
								{!! Form::select('locations', $service, $maintain->location,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'location']) !!}
								<label id="supervisor-error" class="error" for="location">{{$errors->first('location')}}</label>
							@else
								{!! Form::select('location', $service, $maintain->location,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'location']) !!}
							@endif
