@extends('layouts.sammy_new.master') @section('title','Transport Fuel Invoice')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">
		<a href="{{{url('transportLorryFule/viewInvoice')}}}">View Fuel Invoice</a>
  	</li>
		...
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<div class="row">
						<div class="col-xs-6"><strong>View Invoice</strong></div>
                                ...
                                <div class="panel panel-bordered panel-primary" style="margin:5px;">
                                        ...
                                        <div class="panel-body" id="myRadioGroup">
                                            <label class="radio-inline" hidden="">
                                                  <input type="radio" hidden="" name="optradio" id="optradio" value="1" checked>
                                              </label>
<!--                                              <label class="radio-inline">
                                            ...
                                            <div id="optradio4" class="desc">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label required">Supplier</label>
                                                    <div class="col-sm-10">
                                                                @if($errors->has('customer'))
                                                                        {!! Form::select('customer',$customer, Input::old('lorry'),['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'customer']) !!}
                                                                        <label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
                                                                @else
                                                                        {!! Form::select('customer',$customer, Input::old('lorry'),['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'customer']) !!}
                                                                @endif
                                            ...
                                            <div id="optradio2" class="desc">
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                                @if($errors->has('lorry'))
                                                                        {!! Form::select('lorry',$lorry, Input::old('lorry'),['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
                                                                        <label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
                                                                @else
                                                                        {!! Form::select('lorry',$lorry, Input::old('lorry'),['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry']) !!}
                                                                @endif
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                                @if($errors->has('service'))
                                                                        {!! Form::select('service',$service, Input::old('service'),['placeholder' => 'Select supplier','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'service']) !!}
                                                                        <label id="supervisor-error" class="error" for="service">{{$errors->first('service')}}</label>
                                                                @else
                                                                        {!! Form::select('service',$service, Input::old('service'),['placeholder' => 'Select supplier','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'service']) !!}
                                                                @endif
                                        ...
                                        <table class="table table-bordered bordered table-striped table-condensed datatable">
                                            <thead>
                                                    <tr>
                                                            ...
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Invoice Code</th>
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Invoice Date</th>
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Supplier</th>
                                                            <th rowspan="2" class="text-center" style="font-weight:normal;">Chargers</th>	
...
<script type="text/javascript">
        $('#addInvoice').click(function(e){  
            ...
            if(serviceValue =='0'){
                sweetAlert(' Error','Please select supplier.',3);
                return false;
            } 
            ...
            for (var i=0; i<len; i++) {
               if(cboxes[i].checked){
                    ...
                    $.ajax({
                        ...
                        url: 'createInvoice/'+result+'/'+serviceValue,
                        type: 'GET',                  
                        dataType: 'JSON',
                        /* remind that 'data' is the response of the AjaxController */
                        success: function (data) { 
                                loadTable(); 
                                window.open('{{url('transportLorryFule/printpdf')}}/'+data);
...
<script type="text/javascript">
	...
	$(document).ready(function(){
           ...
           $("#content").hide();
            ...
            table = generateTable('.datatable', '{{url('transportLorryFule/json/fuleInvoicesearchlist')}}/'+0+'/'+0+'/'+0,[],[]);
...
<script type="text/javascript">
        ...
        function loadTable(){
                  ...
                  if(optradio==2){
                    ...
                    var r = document.getElementById("service");
                    var serviceValue = r.options[r.selectedIndex].value;  
                    ...
                    table.destroy();
                    table = generateTable('.datatable', '{{url('transportLorryFule/json/fuleInvoicesearchlist')}}/'+invoicedatefrom+'/'+invoicedateto+'/'+serviceValue,[],[]);
