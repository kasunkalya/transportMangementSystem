@extends('layouts.sammy_new.master') @section('title','Edit Book')
@section('css')
    <style type="text/css">
                    ...
                    <form role="form" class="form-horizontal form-validation" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                    {!! Form::select('center',$center, $books->branch,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control @if($errors->has('title')) error @endif" name="title" placeholder="Book Title" required value="{{$books->title}}">
                                @if($errors->has('title'))
                        ...
                        <div class="form-group">
                             <label class="col-sm-2 control-label required">ISBN</label>
                                  <div class="col-sm-8">
                                       <input type="text" class="form-control @if($errors->has('isbn')) error @endif" name="isbn" placeholder="Book ISBN" required value="{{$books->isbn}}">
                                             @if($errors->has('isbn'))
                        ...
                        <div class="form-group">
                             <label class="col-sm-2 control-label required">Author</label>
                                  <div class="col-sm-8">
                                       <input type="text" class="form-control @if($errors->has('author')) error @endif" name="author" placeholder="Book Author" required value="{{$books->author}}">
                           ...
                           <label class="col-sm-2 control-label required">Category</label>
                                <div class="col-sm-8">
                                      @if($errors->has('subject'))
                                          ...
                                          @else
                                          {!! Form::select('category',$category, $books->catagory,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                          @endif
                                </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                    {!! Form::select('type',$type, $books->type,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                    {!! Form::select('subject',$subject, $books->subject,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                @endif
                        ...
                        <div class="form-group">
                             <label class="col-sm-2 control-label required">Rack No</label>
                                  <div class="col-sm-8">
                                       <input type="text" class="form-control @if($errors->has('rack')) error @endif" name="rack" placeholder="Rack Number" required value="{{$books->rack}}">
                                             @if($errors->has('rack'))
                        ...
                        <div class="form-group">
                             <label class="col-sm-2 control-label required">Shell No</label>
                                  <div class="col-sm-8">
                                       <input type="text" class="form-control @if($errors->has('shell')) error @endif" name="shell" placeholder="Shell Number" required value="{{$books->shell}}">
                                             @if($errors->has('shell'))
