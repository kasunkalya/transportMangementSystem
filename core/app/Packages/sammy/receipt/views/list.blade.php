        ...
        <div class="col-xs-12">
            <div class="panel panel-bordered">
                <div class="panel-heading border">
                    <div class="row"><div class="col-xs-6"><strong>Books List</strong></div>
                        <div class="col-xs-6 text-right"><button class="btn btn-success" onclick="location.href = '{{url('books/add')}}';"><i class="fa fa-plus" style="width: 28px;"></i>Add</button></div>
                    </div>
                </div>
                <div class="panel-body">
                    <table class="table table-bordered bordered table-striped table-condensed datatable">
                        ...
                        <tr>
                            ...
                            <th rowspan="2" class="text-center" width="%" style="font-weight:normal;">Book Id</th>
                            <th rowspan="2" class="text-center" style="font-weight:normal;">Tital</th>
                            <th rowspan="2" class="text-center" style="font-weight:normal;">ISBN</th>
                            <th rowspan="2" class="text-center" style="font-weight:normal;">Author</th>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            table = generateTable('.datatable', '{{url('books/json/list')}}',[2],[0]);
