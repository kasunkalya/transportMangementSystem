@extends('layouts.sammy_new.master') @section('title','Add Transport Charging Types')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Add Transport Charging Types</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Add Transport Charging Types</strong>
      		</div>
          	<div class="panel-body">
				...
				<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('mbtqt'))
								{!! Form::select('mbtqt', array(null=>'Select Value','1' => 'Yes', '0' => 'No'), Input::old('mbtqt'),['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'mbtqt']) !!}
								<label id="supervisor-error" class="error" for="mbtqt">{{$errors->first('mbtqt')}}</label>
							@else
								{!! Form::select('mbtqt', array(null=>'Select Value','1' => 'Yes', '0' => 'No'), Input::old('mbtqt'),['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'mbtqt']) !!}
							@endif
		          	...
		          	<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control" name="c_name[]" placeholder="Category Name" value="{{Input::old('c_name[]')}}">
				</div>
	                </div>
                    <hr>
        ...
        function addInput()
            {
                ...
                document.getElementById('responce').innerHTML+='<div class="form-group"><label class="col-sm-2 control-label">Category Name</label><div class="col-sm-10"><input type="text" class="form-control" name="c_name[]" placeholder="Contact Person" id="c_name"></div></div><hr>';
                countBox += 1;
           }
    </script>
<script type="text/javascript">
