	...
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					<div class="col-xs-6"><strong>Employee List</strong></div>
					<div class="col-xs-6 text-right"><a href="{{{url('transportEmployee/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Employee Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
							...
							<th rowspan="2" class="text-center" style="font-weight:normal;">Employee No.</th>
		                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Employee Name</th>
                                        <th rowspan="2" class="text-center" style="font-weight:normal;">NIC</th>
                                        <th rowspan="2" class="text-center" style="font-weight:normal;">EPF</th>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('transportEmployee/json/list')}}',[],[]);
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('transportEmployee/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
