...
<!--				<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('employee_number')) error @endif" name="employee_number" id="employee_number" placeholder="Employee Number" required value="{{$transportEmployee->employee_no}}">
		        ...
		        <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('first_name')) error @endif" name="first_name" id="first_name" placeholder="First Name" required value="{{$transportEmployee->first_name}}">
                       ...
                       <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('last_name')) error @endif" name="last_name" id="last_name" placeholder="Last Name" required value="{{$transportEmployee->last_name}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('full_name')) error @endif" name="full_name" id="full_name" placeholder="Full Name" required value="{{$transportEmployee->full_name}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('nickName')) error @endif" name="nickName" id="nickName" placeholder="Nick Name"  value="{{$transportEmployee->nickName}}">
						...
						<div class="col-sm-10">
							@if($errors->has('company'))
								{!! Form::select('designation',$designation, $transportEmployee->designation,['placeholder' => 'Select Designation','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'designation']) !!}
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('nic')) error @endif" name="nic" id="nic" placeholder="NIC" required value="{{$transportEmployee->nic}}">
							@if($errors->has('nic'))
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('passport')) error @endif" name="passport" id="passport" placeholder="Passport" value="{{$transportEmployee->passport}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('epf_number')) error @endif" name="epf_number" id="epf_number" placeholder="EPF Number" required value="{{$transportEmployee->epf_number}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('address')) error @endif" name="address" id="address" placeholder="Address" required value="{{$transportEmployee->address}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('telephone_numbers')) error @endif" name="telephone_numbers" id="telephone_numbers" placeholder="Telephone Numbers" required value="{{$transportEmployee->contact_mobile}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('t_telephone_numbers')) error @endif" name="t_telephone_numbers" id="t_telephone_numbers" placeholder="Tracking Number"  value="{{$transportEmployee->t_telephone_numbers}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('emergency_numbers')) error @endif" name="emergency_numbers" id="emergency_numbers" placeholder="Emergency Inform Numbers"  value="{{$transportEmployee->emergency_contact}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('eip')) error @endif" name="eip" id="eip" placeholder="Emergency inform person" value="{{$transportEmployee->eip}}">
							@if($errors->has('eip'))
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('bankAccount')) error @endif" name="bankAccount" id="bankAccount" placeholder="Bank Account Number"  value="{{$transportEmployee->bankAccount}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('bankName')) error @endif" name="bankName" id="bankName" placeholder="Bank Name"  value="{{$transportEmployee->bankName}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('branch')) error @endif" name="branch" id="branch" placeholder="Branch"  value="{{$transportEmployee->branch}}">
