@extends('layouts.sammy_new.master') @section('title','Add Insurance Companies')
@section('css')
<style type="text/css">
	...
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Add Insurance Company</strong>
      		</div>
            ...
            if(name !=''){                
                $.ajax({
                    ...
                    success: function (data) { 
                        if(data !=0){
                            sweetAlert(' Error','Insurance company alredy added.',3);
                            return false;
                        }
                    }
                }); 
