@extends('layouts.sammy_new.master') @section('title','View Insurance Companies')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">View Insurance Company</li>
</ol>
<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<strong>View Insurance Company</strong>
				</div>
				<div class="panel-body">
					...
					{!!Form::token()!!}          		
						<div class="form-group">
							...
							<div class="col-sm-10">
										<input type="text" readonly class="form-control @if($errors->has('name')) error @endif" name="name" id="name" placeholder="Name" required value="{{$transportCompany->insurance_company_name}}">
								@if($errors->has('name'))
							...
							<div class="col-sm-10">
										<input type="text" readonly class="form-control @if($errors->has('address')) error @endif" name="address" id="address" placeholder="Address" required value="{{$transportCompany->address}}">
							...
							<div class="col-sm-10">
										<input type="text" readonly class="form-control @if($errors->has('telephone_numbers')) error @endif" name="telephone_numbers" id="telephone_numbers" placeholder="Telephone Numbers" required value="{{$transportCompany->contact_details}}">
			...
			<div class="panel-body">               
						@foreach ($companyContact as $contact)
							...
							<div class="col-sm-10">
										<input type="text" class="form-control" name="c_name[]" readonly placeholder="Contact Name" value="{{$contact->name}}">
					</div>
						</div>
				...
				<div class="form-group">
							...
							<div class="col-sm-10">
										<input type="text" class="form-control" name="c_department[]" readonly placeholder="Contact Department" value="{{$contact->department}}">
						</div>
						</div>
				...
				<div class="form-group">
							...
							<div class="col-sm-10">
										<input type="text" class="form-control" name="c_number[]" readonly placeholder="Contact Number" value="{{$contact->contactNo}}">
						</div>
						</div>
				...
				<div class="form-group">
							...
							<div class="col-sm-10">
										<input type="text" class="form-control" readonly name="c_email[]" placeholder="Contact Email" value="{{$contact->email}}">
					</div>
						</div>	
