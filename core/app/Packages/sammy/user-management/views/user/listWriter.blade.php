@extends('layouts.sammy_new.master') @section('title','Writer List')
@section('css')
<style type="text/css">
    .switch.switch-sm{
        width: 30px;
        ...
        <div class="panel panel-bordered">
            <div class="panel-heading border">
                <div class="row"><div class="col-xs-6"><strong>User List</strong></div>
                    <div class="col-xs-6 text-right"><button onclick="location.href = '{{url('user/addwriter')}}';" class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Add</button></div>
                </div>
            </div>
            <div class="panel-body">
                <table class="table table-bordered bordered table-striped table-condensed datatable">
                    ...
                    <tr>
                        ...
                        <th rowspan="2" class="text-center" style="font-weight:normal;">Job Role</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        table = generateTable('.datatable', '{{url('user/json/listWriter')}}',[0,6,7],[]);
