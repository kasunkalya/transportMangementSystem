@extends('layouts.sammy_new.master') @section('title','Company List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
	...
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					<div class="col-xs-6"><strong>Company List</strong></div>
					<div class="col-xs-6 text-right"><a href="{{{url('transportCompany/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Company Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
		                  	...
		                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Company</th>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('transportCompany/json/list')}}',[],[]);
		...
		table.on('draw.dt',function(){
			...
			$('.type-delete').click(function(e){
				e.preventDefault();
				id = $(this).data('id');
				sweetAlertConfirm('Delete Company', 'Are you sure?',2, deleteFunc);
			});
		});
	});
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('transportCompany/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
