@extends('layouts.sammy_new.master') @section('title','Add Company')
@section('css')
<style type="text/css">
		...
		<div class="panel panel-bordered">
          	...
          	<div class="panel-body">
		        ...
		        <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('register_number')) error @endif" name="register_number" id="register_number" placeholder="Register Number" required value="{{Input::old('register_number')}}">
                    ...
                    <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('vat_number')) error @endif" name="vat_number" id="vat_number" placeholder="Vat Number" required value="{{Input::old('vat_number')}}">
					 ...
					 <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('etf_number')) error @endif" name="etf_number" id="etf_number" placeholder="ETF Number" required value="{{Input::old('etf_number')}}">
			...
			<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('br_number')) error @endif" name="br_number" id="br_number" placeholder="BR Number" required value="{{Input::old('br_number')}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('short_code')) error @endif" name="short_code" id="short_code" placeholder="Short Code" value="{{Input::old('short_code')}}">
							@if($errors->has('short_code'))
								<label id="label-error" class="error" for="short_code">{{$errors->first('short_code')}}</label>name,address,register_number,vat_number,short_code
							@endif
	            		</div>
	                </div>
	            		...
	            		<div class="col-sm-10">
						<input type="text" class="form-control @if($errors->has('fax_numbers')) error @endif" name="fax_numbers" id="fax_numbers" placeholder="Fax Numbers" required value="{{Input::old('fax_numbers')}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="email" class="form-control @if($errors->has('email')) error @endif" name="email" id="email" placeholder="Email" required value="{{Input::old('email')}}">
							@if($errors->has('email'))
                        ...
                        <div class="form-group">
	            		<label class="col-sm-2 control-label">web sites</label>
	            		<div class="col-sm-10">
						<input type="text" class="form-control @if($errors->has('websites')) error @endif" name="websites" placeholder="Web Sites" value="{{Input::old('websites')}}">
