@extends('layouts.sammy_new.master') @section('title','Edit Company')
@section('css')
<style type="text/css">
		...
		<div class="panel panel-bordered">
          	...
          	<div class="panel-body">
		        ...
		        <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('name')) error @endif" name="name" id="name" placeholder="Name" required value="{{$transportCompany->company_name}}">
							@if($errors->has('name'))
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('address')) error @endif" name="address" id="address" placeholder="Address" required value="{{$transportCompany->company_address}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('register_number')) error @endif" name="register_number" id="register_number" placeholder="Register Number" required value="{{$transportCompany->register_number}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('vat_number')) error @endif" name="vat_number" id="vat_number" placeholder="Vat Number" required value="{{$transportCompany->vat_number}}">
			...
			<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('etf_number')) error @endif" name="etf_number" id="etf_number" placeholder="ETF Number" required value="{{$transportCompany->etf_number}}">
			...
			<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('epf_number')) error @endif" name="epf_number" id="epf_number" placeholder="EPF Number" required value="{{$transportCompany->epf_number}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('br_number')) error @endif" name="br_number" id="br_number" placeholder="BR Number" required value="{{$transportCompany->br_number}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('short_code')) error @endif" name="short_code" id="short_code" placeholder="Short Code" required value="{{$transportCompany->short_code}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('start_date')) error @endif" id="start_date" id="start_date" name="start_date" placeholder="Start Date" required value="{{$transportCompany->start_date}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('telephone_numbers')) error @endif" name="telephone_numbers" id="telephone_numbers" placeholder="Telephone Numbers" required value="{{$transportCompany->telephone_numbers}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('fax_numbers')) error @endif" name="fax_numbers" id="fax_numbers" placeholder="Fax Numbers" required value="{{$transportCompany->fax_numbers}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="email" class="form-control @if($errors->has('email')) error @endif" name="email" placeholder="Email" id="Email" required value="{{$transportCompany->email}}">
							@if($errors->has('email'))
	            		...
	            		<div class="col-sm-10">
						<input type="text" class="form-control @if($errors->has('websites')) error @endif" name="websites" placeholder="Web Sites" required value="{{$transportCompany->websites}}">
                        ...
                        @if($transportCompany->brcopy !='')   
                            <div class="form-group">      
                                    ...
                                    <div class="col-sm-10">      
                                        <a class="" href="../../companyAttachments\{{$transportCompany->id }}\{{$transportCompany->brcopy }}"><i class="fa fa-download"></i> BR Copy Download</a>	
                                    </div>
                            </div> 
                        @endif
                        ...
                        <div class="form-group">
                                <label class="col-sm-2 control-label">BR Copy</label>
                                <div class="col-sm-10">      
                                    <input type="file" class="form-control @if($errors->has('brcopy')) error @endif" name="brcopy" placeholder="BR Copy" >
					@if($errors->has('brcopy'))
                                    <label id="label-error" class="error" for="label">{{$errors->first('brcopy')}}</label>
					@endif														
