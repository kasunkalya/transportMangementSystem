@extends('layouts.sammy_new.master') @section('title','Add Leasing Companies')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Add Leasing Company</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Add Leasing Company</strong>
      		</div>
            ...
            if(name !=''){                
                $.ajax({
                    ...
                    success: function (data) { 
                        if(data !=0){
                            sweetAlert(' Error','Leasing company alredy added.',3);
                            return false;
                        }
                    }
                }); 
