@extends('layouts.sammy_new.master') @section('title','View Leasing Companies')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li>
    	<a href="{{{url('transportLeasingCompany/list')}}}">Leasing Company</a>
  	</li>
  	<li class="active">Edit Leasing Company</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Leasing Company</strong>
      		</div>
          	<div class="panel-body">
		        ...
		        <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" readonly="" class="form-control @if($errors->has('name')) error @endif" name="name" id="name" placeholder="Name" required value="{{$transportCompany->leasing_company_name}}">
							@if($errors->has('name'))
		...
		<div class="panel-body">               
			...
			<div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input readonly="" type="text" class="form-control" name="c_number[]" placeholder="Contact Number" value="{{$contact->contactNo}}" >
			        </div>
	                </div>
