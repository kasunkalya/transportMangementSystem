@extends('layouts.sammy_new.master') @section('title','View Charging Rules')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">View Charging Rules</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>View Charging Rules</strong>
      		</div>
          	<div class="panel-body">
          		...
          		{!!Form::token()!!}
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('lorry'))
								{!! Form::select('lorry', $lorry, $chargers->lorry_id,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry','disabled' => true]) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('lorry', $lorry, $chargers->lorry_id,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'lorry','disabled' => true]) !!}
							@endif
						...
						<div class="col-sm-10">
							@if($errors->has('route'))
								{!! Form::select('route', $route, $chargers->route_id,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'route','disabled' => true]) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('route', $route, $chargers->route_id,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'route','disabled' => true]) !!}
							@endif
						...
						<div class="col-sm-10">
							@if($errors->has('chargingType'))
								{!! Form::select('chargingType', $chargesTypes, $chargers->charging_type_id,['class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'chargingType','disabled' => true]) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('chargingType', $chargesTypes, $chargers->charging_type_id,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'chargingType','disabled' => true]) !!}
							@endif
						...
						<div class="col-sm-10">						
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control @if($errors->has('chargers')) error @endif" id="chargers" name="chargers" placeholder="Chargers" value="{{$chargers->charges}}" readonly>
