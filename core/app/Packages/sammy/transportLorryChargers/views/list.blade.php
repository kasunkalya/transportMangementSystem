@extends('layouts.sammy_new.master') @section('title','Charging Rules List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
	...
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					<div class="col-xs-6"><strong>Charging Rules List</strong></div>
					<div class="col-xs-6 text-right"><a href="{{{url('transportLorryChargers/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Charging Rule Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
		                  	...
		                  	<th rowspan="2" class="text-center" style="font-weight:normal;">Route</th>
		                  	<th rowspan="2" class="text-center" width="4%" style="font-weight:normal;">Charging type</th>
					<th rowspan="2" class="text-center" width="4%" style="font-weight:normal;">Chargers</th>							
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('transportLorryChargers/json/list')}}',[],[],[]);
		...
		table.on('draw.dt',function(){
			...
			$('.type-delete').click(function(e){
				e.preventDefault();
				id = $(this).data('id');
				sweetAlertConfirm('Delete Charging Rules Record', 'Are you sure?',2, deleteFunc);
			});
		});
	});
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('transportLorryChargers/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
