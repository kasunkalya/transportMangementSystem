@extends('layouts.sammy_new.master') @section('title','Add Charging Rules')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Add Charging Rules</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Add Charging Rules</strong>
      		</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('chargingType'))
								{!! Form::select('chargingType',$chargesTypes, Input::old('chargingType'),['placeholder' => 'Select Chargin Type','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'chargingType']) !!}
								<label id="supervisor-error" class="error" for="lorry">{{$errors->first('lorry')}}</label>
							@else
								{!! Form::select('chargingType', $chargesTypes, Input::old('chargingType'),['placeholder' => 'Select Chargin Type','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'chargingType']) !!}
							@endif
						...
						<div class="col-sm-10">						
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control @if($errors->has('chargers')) error @endif" id="chargers" name="chargers" placeholder="Chargers" value="{{Input::old('chargers')}}">
            ...
            if(re !=0 && route !=0 && chargingType !=0 && chargers !=''){                
                $.ajax({
                    ...
                    success: function (data) {                  
                        if(data !=0){
                            sweetAlert(' Error','Charging rules alredy added.',3);
                            return false;
                        }
                    }
                }); 
