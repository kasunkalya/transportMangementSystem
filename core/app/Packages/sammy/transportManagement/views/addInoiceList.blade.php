@extends('layouts.sammy_new.master') @section('title','Transport Add Invoice List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">
		<a href="{{{url('transportManagement/addInvoiceList')}}}">Add New Invoice List</a>
  	</li>
		...
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<div class="row">
						<div class="col-xs-6"><strong>Add New Invoice List</strong></div>
					...
					<table class="table table-bordered bordered table-striped table-condensed datatable">
						<thead>
							<tr>
								...
								<th rowspan="2" class="text-center" style="font-weight:normal;">Date</th>
								<th rowspan="2" class="text-center" style="font-weight:normal;">Reference No</th>
								<th rowspan="2" class="text-center" style="font-weight:normal;">No of Trips</th>
            ...
            for (var i=0; i<len; i++) {
               if(cboxes[i].checked){
                    ...
                    $.ajax({
                        ...
                        url: 'createInvoiceList/'+result+'/'+customerValue+'/'+customerValue+'/'+routeValue+'/'+companyValue,
                        type: 'GET',                  
                        dataType: 'JSON',
                        /* remind that 'data' is the response of the AjaxController */
                        success: function (data) { 
                                loadTable(); 
                                window.open('{{url('transportManagement/printpdfList')}}/'+data);
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		table = generateTable('.datatable', '{{url('transportManagement/json/tripInvoicelist')}}/'+0+'/'+0+'/'+0+'/'+0+'/'+0+'/'+0+'/'+0,[],[]);
...
<script type="text/javascript">
        ...
        function loadTable(){
                  ...
                  if(optradio==4){
                    ...
                    table.destroy();
                    table = generateTable('.datatable', '{{url('transportManagement/json/tripInvoicelist')}}/'+optradio+'/'+invoicedatefrom+'/'+invoicedateto+'/'+lorryid+'/'+invoice+'/'+customerid+'/'+route,[],[]);
                    $("#content").show();
