@extends('layouts.sammy_new.master') @section('title','Transport List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
		...
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<div class="row">
						<div class="col-xs-6"><strong>Transport Request</strong></div>
						...
						<thead>
							<tr>
								...
								<th rowspan="2" class="text-center" style="font-weight:normal;">Trip No</th>
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Request Date</th>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('transportManagement/json/list')}}',[],[]);
		...
		table.on('draw.dt',function(){
			...
			$('.type-delete').click(function(e){
				e.preventDefault();
				id = $(this).data('id');
				sweetAlertConfirm('Delete Transport Request Type', 'Are you sure?',2, deleteFunc);
			});
		});
	});
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('transportManagement/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
