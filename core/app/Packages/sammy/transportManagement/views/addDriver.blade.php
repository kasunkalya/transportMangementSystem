@extends('layouts.sammy_new.master') @section('title','Transport Add Driver')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">
		<a href="{{{url('transportManagement/addDriver')}}}">Add Drivers / Helpers</a>
  	</li>
		...
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<div class="row">
						<div class="col-xs-6"><strong>Add Drivers / Helpers</strong></div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		table = generateTable('.datatable', '{{url('transportManagement/json/searchlist')}}/'+0+'/'+0+'/'+0+'/'+0+'/'+0,[],[]);
                   ...
                   if(optradio==3){
                    ...
                    if(invoiceNumber !=''){
                       ...
                       var invoice=0;
                        ...
                        table.destroy();
                        table = generateTable('.datatable', '{{url('transportManagement/json/searchlist')}}/'+optradio+'/'+invoicedatefrom+'/'+invoicedateto+'/'+lorry+'/'+invoice,[],[]);
