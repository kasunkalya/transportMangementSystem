...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">
		<a href="{{{url('transportManagement/addInvoice')}}}">View Invoice</a>
  	</li>
						...
						<thead>
							<tr>
								...
								<th rowspan="2" class="text-center" style="font-weight:normal;">Route</th>
                                                                ...
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Net Amount</th> 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
            ...
            $("#content").hide();
				...
				table = generateTable('.datatable', '{{url('transportManagement/json/invoicesearchlist')}}?searchvalue='+arrStr,[],[]);
