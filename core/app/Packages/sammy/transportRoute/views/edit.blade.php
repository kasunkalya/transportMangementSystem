		...
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<strong>Edit Transport Route</strong>
				</div>
				<div class="panel-body">
					<form role="form" class="form-horizontal form-validation" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
                                                            <input type="text" id="code" class="form-control @if($errors->has('code')) error @endif" name="code" readonly placeholder="Code" required value="{{$transportRoute[0]->route_code}}">
								@if($errors->has('code'))
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
                                                            <input type="text" class="form-control @if($errors->has('name')) error @endif" name="name" id="name" placeholder="Name" required value="{{$transportRoute[0]->route_name}}">
								@if($errors->has('name'))
								...
								@endif
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control @if($errors->has('minDistance')) error @endif" name="minDistance" id="minDistance" placeholder="Minimum Distance" required value="{{$transportRoute[0]->minDistance}}">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control @if($errors->has('driver_rate')) error @endif" name="driver_rate" id="driver_rate" placeholder="Driver Rate" required value="{{$transportRoute[0]->driver_rate}}">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control @if($errors->has('helper_rate')) error @endif" name="helper_rate" id="helper_rate" placeholder="Helper Rate" required value="{{$transportRoute[0]->helper_rate}}">
