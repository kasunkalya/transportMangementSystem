@extends('layouts.sammy_new.master') @section('title','View Route')
@section('css')
	<style type="text/css">
...
@section('content')
	<ol class="breadcrumb">
		...
		<li class="active">View Transport Route</li>
	</ol>
	<div class="row">
		<div class="col-xs-12">
			<div class="panel panel-bordered">
				<div class="panel-heading border">
					<strong>View Transport Route</strong>
				</div>
				<div class="panel-body">
					<form role="form" class="form-horizontal form-validation" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
                                                            <input type="text" id="code" class="form-control @if($errors->has('code')) error @endif" name="code" readonly placeholder="Code" required value="{{$transportRoute[0]->route_code}}" readonly>
								@if($errors->has('code'))
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
                                                            <input type="text" class="form-control @if($errors->has('name')) error @endif" name="name" id="name" placeholder="Name" required value="{{$transportRoute[0]->route_name}}" readonly>
								@if($errors->has('name'))
								...
								@endif
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control @if($errors->has('minDistance')) error @endif" name="minDistance" id="minDistance" placeholder="Minimum Distance" required value="{{$transportRoute[0]->minDistance}}" readonly>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control @if($errors->has('driver_rate')) error @endif" name="driver_rate" id="driver_rate" placeholder="Driver Rate" required value="{{$transportRoute[0]->driver_rate}}" readonly>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control @if($errors->has('helper_rate')) error @endif" name="helper_rate" id="helper_rate" placeholder="Helper Rate" required value="{{$transportRoute[0]->helper_rate}}" readonly="">
