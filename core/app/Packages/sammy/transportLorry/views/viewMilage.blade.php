@extends('layouts.sammy_new.master') @section('title','View Milage Record')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">View Milage Record</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>View Milage Record</strong>
      		</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
            var date={{$date}};
		table = generateTable('.datatable', '{{url('transportLorry/json/milageviewlist')}}/<?php echo $date ?>');
