@extends('layouts.sammy_new.master') @section('title','Edit Lorry')
@section('css')
<style type="text/css">
          		...
          		{!!Form::token()!!}
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							@else
								{!! Form::select('ownerSection', array(null=>'Select Value','1' => 'Group Company', '0' => 'Suppliers'), $lorry[0]->owner_section,['class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'ownerSection']) !!}
							@endif
						...
						<div class="col-sm-10">
							...
							@else
								{!! Form::select('company', $company, $lorry[0]->owner_id,['placeholder' => 'Select Company','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'company']) !!}
							@endif
						...
						<div class="col-sm-10">
                                                    <input type="text" class="form-control @if($errors->has('owner')) error @endif" id="owner" name="owner" placeholder="Owner" value="{{ $lorry[0]->owner_name}}">
                                                    @if($errors->has('owner'))
						...
						<div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                    <input type="text" class="form-control @if($errors->has('licensePlate')) error @endif" id="licensePlate" name="licensePlate" placeholder="License Plate" required value="{{$lorry[0]->licence_plate}}">
						...
						<div class="col-sm-10">
							...
							@else
								{!! Form::select('maker', $maker, $lorry[0]->maker_id,['placeholder' => 'Select Maker','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'maker']) !!}
							@endif
						...
						<div class="col-sm-10">						
                                        ...
                                        <div class="col-sm-10">
                                                <input type="text" class="form-control @if($errors->has('height')) error @endif" id="height" name="height" placeholder="Carriage Height" required value="{{$lorry[0]->height}}">
                                        ...
                                        <div class="col-sm-10">
                                                <input type="text" class="form-control @if($errors->has('Width')) error @endif"  id="Width" name="Width" placeholder="Carriage Width" required value="{{$lorry[0]->width}}">
                                                    @if($errors->has('Width'))
                                        ...
                                        <div class="col-sm-10">
                                                <input type="text" class="form-control @if($errors->has('length')) error @endif"  id="length" name="length" placeholder="Carriage Length" required value="{{$lorry[0]->length}}">
                                        ...
                                        <div class="col-sm-10">
                                                <input type="text" class="form-control @if($errors->has('maxload')) error @endif"  id="maxload" name="maxload" placeholder="Max Pay Load" required value="{{$lorry[0]->max_pay_load}}">
                                        ...
                                        <div id="companyLorryDiv">
                                            ...
                                            <hr>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                        @if($errors->has('insuranceCompanies'))
                                                                                ...
                                                                                <label id="supervisor-error" class="error" for="maker">{{$errors->first('maker')}}</label>
                                                                        @else
                                                                                {!! Form::select('insuranceCompanies', $insuranceCompanies, $lorry[0]->insurance_company_id,['placeholder' => 'Select insurance companies','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                                                        @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">                                                												
                                                                    <input type="text" class="form-control @if($errors->has('insurancedate')) error @endif" name="insurancedate" id="insurancedate" placeholder="Insurance Renew Date" value="{{$lorry[0]->insurance_renew_date}}" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">                                                												
                                                                    <input type="text" class="form-control @if($errors->has('insurancePolicy')) error @endif" name="insurancePolicy" placeholder="Insurance Policy No" value="{{$lorry[0]->insurance_policy_number}}" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">                                                												
                                                                    <input type="text" class="form-control @if($errors->has('noclambonus')) error @endif" name="noclambonus" placeholder="No Claim Bouns" value="{{$lorry[0]->noclambonus}}" >
                                                ...
                                                <hr>
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                        @if($errors->has('emissionCompanies'))
                                                                                ...
                                                                                <label id="supervisor-error" class="error" for="maker">{{$errors->first('maker')}}</label>
                                                                        @else
                                                                                {!! Form::select('emissionCompanies', $emissionCompanies, $lorry[0]->emission_company_id,['placeholder' => 'Select emission companies','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                                                        @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">                                                												
                                                                    <input type="text" class="form-control @if($errors->has('insurancedate')) error @endif" name="Emissiondate" id="Emissiondate" placeholder="Emission Renew Date" value="{{$lorry[0]->emission_renew_date}}" >
                                                ...
                                                <hr>
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">
                                                                        @if($errors->has('maker'))
                                                                                ...
                                                                                <label id="supervisor-error" class="error" for="maker">{{$errors->first('maker')}}</label>
                                                                        @else
                                                                                {!! Form::select('leasingCompanies', $leasingCompanies, $lorry[0]->leasing_company_id,['placeholder' => 'Select leasing companies','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After']) !!}
                                                                        @endif
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">                                                												
                                                                    <input type="text" class="form-control @if($errors->has('leasingAmount')) error @endif" name="leasingAmount" placeholder="Leasing Amount" value="{{$lorry[0]->leasing_amount}}" >
