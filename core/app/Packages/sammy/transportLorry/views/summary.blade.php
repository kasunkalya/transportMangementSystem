				...
				<div class="panel-body" id="content">
						...
						<thead>
							<tr>
								...
								<th rowspan="2" class="text-center" style="font-weight:normal;">Lorry No</th>
								<th rowspan="2" class="text-center" style="font-weight:normal;">Trip km</th>
								<th rowspan="2" class="text-center" style="font-weight:normal;">Miter Reading km</th>
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Fuel Chargers</th>
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Repair Chargers</th>
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Service Chargers</th> 
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Driver Chargers</th> 
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Helper Chargers</th> 
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Trip Income</th> 
                                                                <th rowspan="2" class="text-center" style="font-weight:normal;">Trip(km) Income</th> 
								<th colspan="1" class="text-center" width="4%" style="font-weight:normal;">Miter Reading Income</th>
							</tr>
...
<script type="text/javascript">
        ...
        function loadTable(){
                    ...
                    table.destroy();
                    table = generateTable('.datatable', '{{url('transportLorry/json/summaysearchlist')}}/'+invoicedatefrom+'/'+invoicedateto,[],[]);
                    $("#content").show();
