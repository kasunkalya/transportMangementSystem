@extends('layouts.sammy_new.master') @section('title','Edit Repair Record')
@section('css')
<style type="text/css">
...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">Edit Repair Record</li>
</ol>
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
        		<strong>Edit Repair Record</strong>
      		</div>
			...
			<div class="col-sm-10">     
								...
								{!! Form::select('garage', $service, $maintain->garage,['placeholder' => 'Select garage','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'garage']) !!}
								<label id="supervisor-error" class="error" for="location">{{$errors->first('location')}}</label>
							@else
								{!! Form::select('garage', $service, $maintain->garage,['placeholder' => 'Select garage','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'garage']) !!}
							@endif
