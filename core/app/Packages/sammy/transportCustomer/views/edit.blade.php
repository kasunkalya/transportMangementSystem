@extends('layouts.sammy_new.master') @section('title','Edit Transport Customer')
@section('css')
<style type="text/css">
		...
		<div class="panel panel-bordered">
          	...
          	<div class="panel-body">
		         ...
		         <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('invoice_code')) error @endif" name="invoice_code" id="invoice_code"  placeholder="Invoice Code" required value="{{$customer->invoice_code}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('name')) error @endif" name="name" id="name"  placeholder="Name" required value="{{$customer->customer_name}}">
							@if($errors->has('name'))
                       ...
                       <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('othername')) error @endif" name="othername" id="othername" placeholder="Other Name"  value="{{$customer->other_name}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('address')) error @endif" name="address" id="address" placeholder="Address"  value="{{$customer->address}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('telephone')) error @endif" name="telephone" id="telephone" placeholder="Telephone Number"  value="{{$customer->telephone_number}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('fax')) error @endif" name="fax" id="fax" placeholder="Fax Number"  value="{{$customer->fax_number}}">
							@if($errors->has('fax'))
	            		...
	            		<div class="col-sm-10">
                                    <input type="email" class="form-control @if($errors->has('email')) error @endif" name="email" id="email" placeholder="Email"  value="{{$customer->email}}">
							@if($errors->has('email'))
                    ...
                    <div class="form-group">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" class="form-control @if($errors->has('website')) error @endif" name="website" id="website" placeholder="Website"  value="{{$customer->website}}">
	            		...
	            		<div class="col-sm-10">
                                    <input type="text" id="start_date" class="form-control @if($errors->has('start_date')) error @endif" name="start_date" id="start_date" placeholder="Start Date" required value="{{$customer->customer_since}}">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('invoice'))
								{!! Form::select('invoice', $muthumalaInvoice,$customer->invoiceLayoutId,['placeholder' => 'Select Invoice Layout','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'invoice']) !!}
								<label id="supervisor-error" class="error" for="invoice">{{$errors->first('invoice')}}</label>
							@else
								{!! Form::select('invoice', $muthumalaInvoice,$customer->invoiceLayoutId,['placeholder' => 'Select Invoice Layout','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'invoice']) !!}
							@endif
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							@if($errors->has('invoiceSummary'))
								{!! Form::select('invoiceSummary', $muthumalaInvoiceSummary,$customer->invoiceSummaryLayoutId,['placeholder' => 'Select Invoice Summary Layout','class'=>'chosen error','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'invoiceSummary']) !!}
								<label id="supervisor-error" class="error" for="invoice">{{$errors->first('invoice')}}</label>
							@else
								{!! Form::select('invoiceSummary', $muthumalaInvoiceSummary,$customer->invoiceSummaryLayoutId,['placeholder' => 'Select Invoice Summary Layout','class'=>'chosen','style'=>'width:100%;','required','data-placeholder'=>'Set After','id'=>'invoiceSummary']) !!}
							@endif
