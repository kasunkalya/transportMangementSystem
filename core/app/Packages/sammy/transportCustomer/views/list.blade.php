...
<ol class="breadcrumb">
	<li>
  	...
  	<li class="active">
		<a href="{{{url('transportCustomer/list')}}}">Customer List</a>
  	</li>
		...
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					...
					<div class="col-xs-6 text-right"><a href="{{{url('transportCustomer/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Customer Add</button></a></div>
				</div>
      		</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('transportCustomer/json/list')}}',[],[]);
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('transportCustomer/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
